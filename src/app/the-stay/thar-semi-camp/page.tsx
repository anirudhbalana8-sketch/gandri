...
const amenities: { label: string; icon: LucideIcon }[] = [
  { label: "Camp Size 220/- sqr", icon: Ruler },
            ...
            <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
              <div>
                ...
                <h2 className="mt-4 font-display text-5xl leading-none md:text-7xl">
                  A luxurious stay inside the Arabian desert.
                </h2>
                <p className="mt-6 text-lg leading-8 text-ink/75 md:text-xl">
                  Our Thar Semi Suites are designed for guests who seek a little
                  more space, comfort, and luxury while staying close to the raw
                  beauty of the desert.
                </p>
                <p className="mt-6 text-lg leading-8 text-ink/75 md:text-xl">
                  Spread across 500 sq. ft., each Semi Suite features a spacious
                  250 sq. ft. room, thoughtfully designed to create a luxurious
                  and comfortable indoor experience. Modern amenities, refined
                  interiors, and generous space come together to make your
                  desert stay effortless and relaxing.
                </p>
                <p className="mt-6 text-lg leading-8 text-ink/75 md:text-xl">
                  With only four Thar Semi Suites, thoughtfully spaced
                  approximately 20 feet apart, each guest enjoys a greater sense
                  of privacy, peace, and personal space.
                  <br />A little more room. A little more comfort. And the
                  timeless Thar just outside your door.
                </p>
              </div>
            ...
            <div className="mt-20 grid gap-10 md:grid-cols-2 md:items-center">
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-ink/75">
                  ...
                  your stay is taken care of. From the moment you step into our
                  camp until your departure, we strive to create a memorable and
                  seamless experience for you and your loved ones.
                </p>
              </div>
            </div>
